...
var require_geometry_extrude = __commonJS({
  "node_modules/geometry-extrude/dist/geometry-extrude.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.geometryExtrude = {}));
      ...
      function scale(out, v3, s) {
        out[0] = v3[0] * s;
        out[1] = v3[1] * s;
        out[2] = v3[2] * s;
        return out;
      }
      function scaleAndAdd(out, v12, v22, s) {
        out[0] = v12[0] + v22[0] * s;
        out[1] = v12[1] + v22[1] * s;
        out[2] = v12[2] + v22[2] * s;
        return out;
      ...
      function innerOffsetPolygon(vertices2, out, start, end, outStart, offset, miterLimit, close, removeIntersections) {
        ...
        for (var i = start; i < end; i++) {
          ...
          var x2 = vertices2[i * 2];
          var y2 = vertices2[i * 2 + 1];
      ...
      function offsetPolygon(vertices2, holes, offset, miterLimit, close) {
        ...
        if (holes) {
          for (var i = 0; i < holes.length; i++) {
            var start = holes[i];
            var end = holes[i + 1] || vertices2.length / 2;
      ...
      function convertPolylineToTriangulatedPolygon(polyline, polylineIdx, opts) {
        ...
        for (var i = 0, k = 0; i < pointCount; i++) {
          points[k++] = polyline[i][0] * scale2[0] + translate[0];
          points[k++] = polyline[i][1] * scale2[1] + translate[1];
        }
      ...
      function extrudePolyline2(polylines, opts) {
        opts = Object.assign({}, opts);
        var min = [Infinity, Infinity];
        var max = [-Infinity, -Infinity];
      ...
      function extrudeGeoJSON(geojson, opts) {
        ...
        return {
          polyline: extrudePolyline2(polylines, Object.assign(opts, {
      ...
      exports2.extrudePolygon = extrudePolygon;
      exports2.extrudePolyline = extrudePolyline2;
...
async function runGenerator(input) {
  ...
  const results = (0, import_geometry_extrude.extrudeGeoJSON)(
    json,
    {
